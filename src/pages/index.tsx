          ...
          <Stack direction={["column", "row"]} spacing="24px" py="20px">
            ...
            {updatedData && (
              <VStack spacing={4} w="full" alignItems="start">
                <Box minH="30px">
                  <TypewriterEffect
                    text="Amazing job 🙌 You can now download or copy your menu with prices updated"
                    speed={70}
                  />
                </Box>
                ...
                <ButtonGroup>
                  <ActionHoverButton
                    ...
                    onButtonClick={() =>
                      handleCopy(updatedData, setCopiedUpdatedMenu)
                    }
                    colorScheme="mobiColor"
                    color="black"
                    size="sm"
                    ...
                    onMouseEnter={() =>
                      setHoveredText("Copy raw updated Json menu")
                    }
                    onMouseLeave={() => setHoveredText("")}
                  />
                  ...
                  <ActionHoverButton
                    buttonText="Download Menu"
                    onButtonClick={() =>
                      downloadFileWithData(updatedData, `menu_updated.json`)
                    }
                    colorScheme="mobiColor"
                    color="black"
                    size="sm"
                    fontSize="xs"
                    onMouseEnter={() =>
                      setHoveredText("Download updated menu as a Json file")
                    }
                    onMouseLeave={() => setHoveredText("")}
                  />
                  <ActionHoverButton
                    buttonText="Download Excel"
                    onButtonClick={() =>
                      handleDownloadExcelPricesFile(updatedData)
                    }
                    colorScheme="mobiColor"
                    color="black"
                    size="sm"
                    fontSize="xs"
                    onMouseEnter={() =>
                      setHoveredText("Download updated menu as an Excel file")
                    }
                    onMouseLeave={() => setHoveredText("")}
                  />
                </ButtonGroup>
